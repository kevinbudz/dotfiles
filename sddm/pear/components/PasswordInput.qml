...
Item {
    ...
    readonly property int maxVisibleChars: 12
    ...
    readonly property int bulletSpacing: 2
    ...
    Text {
        ...
        Binding on font.family {
            value: fonts.choose(config.passwordPlaceholderFont, config.globalFont)
            when: fonts.hasChoice(config.passwordPlaceholderFont, config.globalFont)
        }

        Binding on font.weight {
            value: fonts.weight(config.passwordPlaceholderFontWeight, config.globalFontWeight)
            when: fonts.hasWeight(config.passwordPlaceholderFontWeight, config.globalFontWeight)
        }

        Binding on font.italic {
            value: fonts.italic(config.passwordPlaceholderFontStyle, config.globalFontStyle)
            when: fonts.hasStyle(config.passwordPlaceholderFontStyle, config.globalFontStyle)
        }
    }
    ...
    Text {
        ...
        Binding on font.family {
            value: fonts.choose(config.capsLockFont, config.globalFont)
            when: fonts.hasChoice(config.capsLockFont, config.globalFont)
        }

        Binding on font.weight {
            value: fonts.weight(config.capsLockFontWeight, config.globalFontWeight)
            when: fonts.hasWeight(config.capsLockFontWeight, config.globalFontWeight)
        }

        Binding on font.italic {
            value: fonts.italic(config.capsLockFontStyle, config.globalFontStyle)
            when: fonts.hasStyle(config.capsLockFontStyle, config.globalFontStyle)
        }
    }
